 ...
 * The event is cancellable.
*/
declare function onEvent(name: "ftbquests.custom_task.58E191720522C96A", handler: (event: Internal.CustomTaskEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **client**.
 * 
...
declare function onForgeEvent(name: "ovh.corail.tombstone.api.event.PhantomSpawnerEvent$CheckPhantomSpawn", handler: (event: Internal.PhantomSpawnerEvent$CheckPhantomSpawn) => void);
...
declare function onForgeEvent(name: "harmonised.pmmo.api.events.XpEvent", handler: (event: Internal.XpEvent) => void);
...
declare function onForgeEvent(name: "com.ferreusveritas.dynamictrees.event.PoissonDiscProviderCreateEvent", handler: (event: Internal.PoissonDiscProviderCreateEvent) => void);
...
declare function onForgeEvent(name: "com.ferreusveritas.dynamictrees.event.SpeciesPostGenerationEvent", handler: (event: Internal.SpeciesPostGenerationEvent) => void);
...
declare function onForgeEvent(name: "net.minecraftforge.event.entity.living.ShieldBlockEvent", handler: (event: Internal.ShieldBlockEvent) => void);
declare function onForgeEvent(name: "futurepack.api.event.ResearchPageRegisterEvent", handler: (event: Internal.ResearchPageRegisterEvent) => void);
...
declare function onForgeEvent(name: "it.hurts.sskirillss.relics.api.events.common.ContainerSlotClickEvent", handler: (event: Internal.ContainerSlotClickEvent) => void);
...
declare function onForgeEvent(name: "ovh.corail.tombstone.api.event.PhantomSpawnerEvent$TimeForCheck", handler: (event: Internal.PhantomSpawnerEvent$TimeForCheck) => void);
...
declare function onForgeEvent(name: "de.keksuccino.fmaudio.events.PreScreenInitEvent", handler: (event: Internal.PreScreenInitEvent) => void);
...
declare function onForgeEvent(name: "io.github.edwinmindcraft.origins.api.event.AutoBadgeEvent", handler: (event: Internal.AutoBadgeEvent) => void);
