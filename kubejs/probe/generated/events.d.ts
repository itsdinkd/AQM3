...
declare function onForgeEvent(name: "com.github.alexthe666.iceandfire.api.event.GenericGriefEvent", handler: (event: Internal.GenericGriefEvent) => void);
...
declare function onForgeEvent(name: "com.ferreusveritas.dynamictrees.event.SeedVoluntaryPlantEvent", handler: (event: Internal.SeedVoluntaryPlantEvent) => void);
